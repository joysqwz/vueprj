          ...
          <div>
            <form @submit.prevent="changePassword" class="password-form">
              ...
              <div class="password-form__field">
                <label for="currentPassword" class="password-form__field-label"
              ...
              <div class="password-form__field">
                <label for="confirmPassword" class="password-form__field-label"
...
const changePassword = async () => {
  ...
  try {
    ...
    alert('Ошибка при смене пароля: ' + error.response.data.message || error)
  }
}
